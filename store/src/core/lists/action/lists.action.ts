...
export const ActionTypes = {
    ...
    GET_SHOW_LESS: type('[show] get show less'),
...
// product GetShowLess  action
export class GetShowLess implements Action {
    type = ActionTypes.GET_SHOW_LESS;

    constructor(public payload: any) {
    }
}

// product GetViewAll  action
export class GetViewAll implements Action {
    type = ActionTypes.GET_VIEW_ALL;
