...
export interface ListsState extends Map<string, any> {
    ...
    categoryShowless: Array<CountryResponseModel>;
    categoryShowlessResponse: boolean;
    categoryShowlessRequestLoading: boolean;
    categoryShowlessRequestLoaded: boolean;
    categoryShowlessRequestFailed: boolean;
...
export const listsRecord = Record({
    ...
    categoryShowlessRequestLoading: false,
