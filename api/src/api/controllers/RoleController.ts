...
export class RoleController {
    ...
    @Get ('/rolelist')
    @Authorized()
    public async roleList(@QueryParam('limit') limit: number, @QueryParam('offset') offset: number, @QueryParam('keyword') keyword: string, @QueryParam('count') count: number | boolean, @Res() response: any): Promise<any> {
