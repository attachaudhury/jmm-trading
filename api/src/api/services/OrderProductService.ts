...
export class OrderProductService {
    ...
    public async findData(productid: number , orderid: number): Promise<OrderProduct[]> {
        this.log.info('find a order product data');
        return this.orderProductRepository.find({where: {productId: productid, orderId: orderid}});
