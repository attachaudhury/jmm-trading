...
export class EmailTempListComponent implements OnInit {
    ...
    constructor(private router: Router, public sandbox: EmailTempSandbox, public service: EmailTempService) {
    ...
    addNewEmailTemp() {
        ...
        this.router.navigate(['/settings/emailtemp/add']);
    }

    // Edit EmailTemp navigate to Add Form
    editEmailtemp(list) {
        this.service.setemailtemplistdata(list);
        this.router.navigate(['/settings/emailtemp/edit', list.emailTemplateId]);
    }
