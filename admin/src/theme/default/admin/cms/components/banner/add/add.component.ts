 ...
 */
import {Component, ViewEncapsulation, ElementRef, ViewChild, ChangeDetectorRef, OnInit} from '@angular/core';
    ...
    editBannerData() {
        ...
        if (this.bannerInfo && this.bannerInfo[0]) {
            ...
            for (let i = 0; i < this.bannerInfo.length; i++) {
                ...
                this.postImageUrl = this.imageUrl + '?width=160&height=150&path=' +
                    `${this.bannerInfo[0].imagePath}` + '&name=' + `${this.bannerInfo[0].image}`;
