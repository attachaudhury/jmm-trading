...
import {
    ...
    getbucketlistRequestLoaded, getSearchFolder,
    getSearchFolderResponse, getSearchFolderRequestLoading,
    getSearchFolderRequestLoaded, getSearchFolderRequestFailed
...
export class MediaSandbox {
    ...
    public getSearchFolderResponse$ = this.appState.select(getSearchFolderResponse);
    public getSearchFolderRequestLoading$ = this.appState.select(getSearchFolderRequestLoading);
    public getSearchFolderRequestLoaded$ = this.appState.select(getSearchFolderRequestLoaded);
    public getSearchFolderRequestFailed$ = this.appState.select(getSearchFolderRequestFailed);
