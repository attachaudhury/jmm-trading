...
export const getSearchFolderResponse = (state: Media) => state.searchFolderResponse;
export const getSearchFolderRequestLoading = (state: Media) => state.searchFolderRequestLoading;
export const getSearchFolderRequestLoaded = (state: Media) => state.searchFolderRequestLoaded;
export const getSearchFolderRequestFailed = (state: Media) => state.searchFolderRequestFailed;
