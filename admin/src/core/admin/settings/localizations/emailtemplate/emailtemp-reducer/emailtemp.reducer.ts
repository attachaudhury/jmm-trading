...
export function reducer(state = initialState, {type, payload}: any): EmailTempState {
    if (!type) {
        return state;
    }
...
export const getupdateemailtemp = (state: EmailTempState) => state.updateEmailTemp;
export const getdeleteemailtemp = (state: EmailTempState) => state.emailTempDelete;
export const getemailtemplist = (state: EmailTempState) => state.emailTempList;
export const getemailtempagination = (state: EmailTempState) => state.emailTempPagination;

export const getEmailTempListLoading = (state: EmailTempState) => state.listLoading;
export const getEmailTempListLoaded = (state: EmailTempState) => state.listLoaded;
export const getEmailTempListFailed = (state: EmailTempState) => state.listFailed;

export const getEmailTempCountLoading = (state: EmailTempState) => state.countLoading;
export const getEmailTempCountLoaded = (state: EmailTempState) => state.countLoaded;
export const getEmailTempCountFailed = (state: EmailTempState) => state.countFailed;

export const getEmailTempAddLoading = (state: EmailTempState) => state.addLoading;
...
export const getEmailTempUpdateLoading = (state: EmailTempState) => state.updateLoading;
export const getEmailTempUpdateLoaded = (state: EmailTempState) => state.updateLoaded;
export const getEmailTempUpdateFailed = (state: EmailTempState) => state.updateFailed;

export const getEmailTempDeleteLoading = (state: EmailTempState) => state.deleteLoading;
export const getEmailTempDeleteLoaded = (state: EmailTempState) => state.deleteLoaded;
export const getEmailTempDeleteFailed = (state: EmailTempState) => state.deleteFailed;
